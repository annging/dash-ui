      ...
      <el-row class="list">
        <el-table
          ...
          <el-table-column
              ...
              width="">
              <template slot-scope="{row}">
                <img :src="row.imgUrl" style="width: 200px;height: 100px;">
              </template>
            </el-table-column>
          <el-table-column
            label="url">
...
export default {
  ...
  methods: {
    getList() {
      ...
      this.list = [{
        id: 1,
        imgUrl: 'https://annging.github.io/blog/images/logo.png',
    ...
    goCreate() {
      this.$router.push({ path: '/platform/mer/banner/create' })
    },
    handleEdit(index, row) {
      this.$router.push({ path: '/platform/mer/banner/edit/' + row.id });
    },
