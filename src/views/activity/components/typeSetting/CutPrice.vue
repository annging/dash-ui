<template>
	<div>
      ...
      <el-form-item label="商品数量" prop="">
      	<el-input type="digit" v-model="activity.activitySetting.productNum" maxlength="5" placeholder="请合理设置"></el-input>
      </el-form-item>
      <el-form-item label="原价" prop="">
      	<el-input type="digit" v-model="activity.activitySetting.originPrice" maxlength="5" placeholder="原价"></el-input>
      </el-form-item>
      <el-form-item label="底价" prop="">
      	<el-input type="digit" v-model="activity.activitySetting.basePrice" maxlength="5" placeholder="最低砍到多少元"></el-input>
      </el-form-item>
      <el-form-item label="砍价次数" prop="">
      	<el-input type="number" v-model="activity.activitySetting.totalTimes" maxlength="5" placeholder="多少人帮砍到底价"></el-input>
      </el-form-item>
      <el-form-item label="单人份数" prop="">
      	<el-input type="number" v-model="activity.activitySetting.quotaPrePerson" maxlength="5" placeholder="单人最多可购买次数"></el-input>
      </el-form-item>
      <el-form-item label="限时砍价" prop="">
      	<el-select v-model="activity.activitySetting.timeLimit" placeholder="请选择" style="width: 600px;">
      ...
      <el-form-item label="砍价者手机号">
        <el-switch
          v-model="activity.activitySetting.showPhone"
          active-color="#13ce66"
          :active-value="true"
          :inactive-value="false">
        </el-switch>
      </el-form-item>
      <el-form-item label="砍价列表显示">
        <el-switch
      ...
      <el-form-item label="按钮文案（可自定义）" prop="">
      	<el-input v-model="activity.activitySetting.buttonText" maxlength="10" placeholder="立即砍价"></el-input>
      </el-form-item>
