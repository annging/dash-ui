...
<script>
import { fetchScheme, updateActivityScheme, getActivitys, fetchPageAdvisers } from '@/api/activity'
...
export default {
  ...
  methods: {
    ...
    handleSuccess2(res, file) {
      this.schemeForm.poster = 'https://ttz-user-file.qiniu.tuantuanzhan.cn/' + res.key
    },
