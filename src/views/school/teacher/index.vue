	...
	<div class="main-content">
	  <div class="left-container">
	    <el-menu default-active="1" class="" mode="horizontal" router style="margin-bottom: 20px;">
		    <el-menu-item index="1" :route="{path:'/school/teacher/index'}">导师列表</el-menu-item>
	    </el-menu>
...
export default {
  ...
  methods: {
    ...
    goCreate() {
      this.$router.push({ path: '/school/teacher/create' })
    },
    handleEdit(index, row) {
      this.$router.push({ path: '/school/teacher/edit/' + row.id });
    },
